  ...
  case iType of
    3: // DID
      begin
        ...
        Frame_DID_ComboDIDViewType.Label_Key.Caption := arrDIDList[Frame_DID_ComboDIDViewType.Tag];
        Frame_DID_ComboBelltype.Tag := DID_Opations.iVoiceType;
        Frame_DID_ComboDIDViewType.Label_Key.Caption := arrDIDCallTypeList[Frame_DID_ComboBelltype.Tag];
