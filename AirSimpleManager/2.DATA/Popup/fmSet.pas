...
begin
  ...
  else if DM.DBCodeChk('HSET', 'SETCODE', sCODE) then
  begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              ParamByName('UPDT').AsString := sDateTime;
      ...
      1: // 세트 수정
        begin
          ...
          begin
            ...
            with DM.FDQ do
            begin
              SQL.Text := 'UPDATE HSET SET SETNAME = :NAME, GUBUN = :GUBUN, CNT = :CNT, UPDT = :UPDT WHERE SETCODE = :CODE';
              ParamByName('CODE').AsString := sCODE;
              ParamByName('NAME').AsString := DM.AnsiFormat(sName);
              ParamByName('GUBUN').AsInteger := iSetType;
              ParamByName('CNT').AsInteger := iCnt;
