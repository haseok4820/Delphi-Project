...
procedure TfmKeypad.ClickPad(Sender: TObject);
var
  i: Byte;
begin
  //
  ...
  end;
  {
    for i := 0 to 11 do
    begin
    with (FindComponent('NavPad_' + intToStr(i)) as Tbutton) do
    begin
    Color := clwhite;
    Font.Color := clBlack;
    end;
    ...
    with (FindComponent('NavPad_' + intToStr((Sender as Tbutton).Tag)) as Tbutton) do
    begin
    Color := $00F0B000;
    Font.Color := clwhite;
    end;
...
procedure TfmKeypad.EditChk(Sender: TObject);
begin
...
procedure TfmKeypad.Timer_AllClearTimer(Sender: TObject);
begin
