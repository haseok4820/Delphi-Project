...
begin
  ...
  if (Control is TCustomButton) and TCustomButton(Control).WordWrap then
     DrawControlText(ACanvas, Details, BCaption, R, DT_VCENTER or DT_CENTER or DT_WORDBREAK or DT_CALCRECT)
   else
     DrawControlText(ACanvas, Details, BCaption, R, DT_VCENTER or DT_CENTER or DT_CALCRECT);
  Result := R.Width;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        IX := DrawRect.CenterPoint.X - GetTextWidth div 2 - IW - 2;
    ...
    if Control is TCustomButton then
      with TCustomButton(Control) do
       case ImageAlignment of
          iaCenter:
            begin
              IX := DrawRect.CenterPoint.X - IW div 2;
            end;
          iaLeft:
            begin
              IX := DrawRect.Left + 2;
  ...
  begin
    ...
    StyleServices.DrawText(ACanvas.Handle, Details, BCaption, R, TextFormat, ACanvas.Font.Color);
    ...
    begin
      ...
      if FPressed then
        ...
        Details := StyleServices.GetElementDetails(tbCommandLinkGlyphDefaulted)
      else if AMouseInControl then
    ...
    begin
      ...
      DrawControlText(ACanvas, Details, Text, DrawRect, Control.DrawTextBiDiModeFlags(DT_VCENTER or DT_CENTER));
      if FDropDown then
      begin
        Details := StyleServices.GetElementDetails(tbPushButtonPressed);
      ...
      if (Control is TCustomButton) and TCustomButton(Control).WordWrap then
        DrawControlText(ACanvas, Details, BCaption, DrawRect,
          Control.DrawTextBiDiModeFlags(DT_VCENTER or DT_CENTER or DT_WORDBREAK))
      else
        DrawControlText(ACanvas, Details, BCaption, DrawRect,
          Control.DrawTextBiDiModeFlags(DT_VCENTER or DT_CENTER));
end;
