...
procedure TfmENV1_2.ButtonClearClick(Sender: TObject);
begin
  Edit_Renewal.Text := '';
  Edit_Original.Text := '';
end;
...
begin
  ...
  ButtonClear.Visible := CheckBox_Update.Checked;
end;
  ...
  begin
    ...
    begin
      if (Edit_Original.Text = '') then
        Edit_Original.Text := IntToStr(iSel_SEQ + 1)
      else // if (Edit_Renewal.Text = '') then
        Edit_Renewal.Text := IntToStr(iSel_SEQ + 1);
    end;
  end;
end;
